...
RSpec.describe InvoiceItem, type: :model do
  ...
  describe "#discount_rate" do 
    it "returns the highest discount rate for which an item qualifies based on the quantity purchased" do 
      ...
      item1 = Item.create!(name: "Item Qui Esse", description: "Nihil autem sit odio inventore deleniti.", unit_price: 75107, merchant_id: merchant1.id)
      invoice1 = Invoice.create!(status: "completed", customer_id: customer1.id, created_at: "2012-03-25 09:54:09 UTC", updated_at: "2012-03-25 09:54:09 UTC")
      invoice_item1 = InvoiceItem.create!(item_id: item1.id, invoice_id: invoice1.id, quantity: 9, unit_price: 111, status: 1, created_at: "2012-03-25 09:54:09 UTC") 
      invoice_item2 = InvoiceItem.create!(item_id: item1.id, invoice_id: invoice1.id, quantity: 10, unit_price: 75107, status: 1, created_at: "2012-03-24 09:54:09 UTC") 
      invoice_item3 = InvoiceItem.create!(item_id: item1.id, invoice_id: invoice1.id, quantity: 14, unit_price: 75107, status: 1, created_at: "2012-03-26 09:54:09 UTC") 
      invoice_item4 = InvoiceItem.create!(item_id: item1.id, invoice_id: invoice1.id, quantity: 15, unit_price: 75107, status: 1, created_at: "2012-03-26 09:54:09 UTC") 
      invoice_item5 = InvoiceItem.create!(item_id: item1.id, invoice_id: invoice1.id, quantity: 19, unit_price: 75107, status: 1, created_at: "2012-03-26 09:54:09 UTC") 
      invoice_item6 = InvoiceItem.create!(item_id: item1.id, invoice_id: invoice1.id, quantity: 20, unit_price: 75107, status: 1, created_at: "2012-03-26 09:54:09 UTC") 
      discount1 = Discount.create!({discount: 20, qty: 10, merchant_id: merchant1.id})
